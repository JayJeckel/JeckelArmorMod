...
public class Refs
{
	...
	public static MappedCreativeTab getTab() { return _creativeTab; }
	...
	public static void pre(final Object modInstance, final FMLPreInitializationEvent event)
	{
		...
		_creativeTab = new MappedCreativeTab(Refs.ModId);
	...
	public static void initialize(FMLInitializationEvent event)
	{
		...
		if (JeckelArmorMod.CfmMod != null) { CFMModRecipeRegistry.send(); }
	}
